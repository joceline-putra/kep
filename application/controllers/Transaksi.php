...
class Transaksi extends MY_Controller{
    ...
    function print_group($session){ //Not Used, Standard Print Group By Product
        //Header
        $params = array(
            'trans_session' => $session
        );
    ...
    function prints_share($printer_id, $trans_id){ //Not Used
        ...
        if($get_trans){
            ...
            // //Header
            //     $text .= dot_set_wrap_1($get_branch['branch_name']);
            //     $text .= dot_set_wrap_1($get_branch['branch_address']);
            //     $text .= dot_set_wrap_1($get_branch['branch_phone_1']);                
            //     $text .= dot_set_wrap_1($get_trans['trans_number']);
            //     $text .= dot_set_wrap_1(date("d/m/Y - H:i:s", strtotime($get_trans['trans_date'])));    
            ...
            //     $text .= dot_set_wrap_1("Terima kasih atas kunjungannya");
