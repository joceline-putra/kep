    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
        ...
        <ul id="sidebar" class="sidebarz">
            ...
            <li class="start"> 
                <a href="<?php echo base_url('admin'); ?>">
                    <i class="fas fa-home"></i>
                    <span class="title">Kepooin</span> <span class="selected"></span>
                </a> 
                <li class="start open">
                    <ul class="open sub-menu" style="display:block;">
                        <li><a href="<?php echo site_url('kepooin/shortlink')?>"><i class="fas fa-hdd" style="display:<?php echo $icon; ?>"></i> Short Link</a></li>
                    </ul>
                </li>                       
            </li>            
            <li class="start"> 
