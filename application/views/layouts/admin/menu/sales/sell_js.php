            ...
            $.ajax({
                ...
                success: function (d) {
                    if (parseInt(d.status) == 1) { /* Success Message */
                        ...
                        $("#form-trans input[name='trans_person_name']").val(d.result.trans_person_name);
                        ...
                        if (parseInt(d.result.contact_termin) > 0) {
                            $("select[id='syarat_pembayaran']").append('' + '<option value="' + d.result.contact_termin + '">' + d.result.contact_termin + ' Hari' + '</option>');
                            $("select[id='syarat_pembayaran']").val(d.result.contact_termin).trigger('change');
                        }else{
                            $("select[id='syarat_pembayaran']").append('' + '<option value="' + d.result.contact_termin + '"> Cash (COD)</option>');
                            $("select[id='syarat_pembayaran']").val(0).trigger('change');                            
                        }
