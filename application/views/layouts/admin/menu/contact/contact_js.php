    ...
    $(document).ready(function () {
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                ...
                {"targets": 2, "title": "Alamat", "searchable": true, "orderable": true},
                {"targets": 3, "title": "Telepon", "searchable": true, "orderable": true},
                {"targets": 4, "title": "Email", "searchable": false, "orderable": false},
                {"targets": 5, "title": "Company", "searchable": false, "orderable": false},
                {"targets": 6, "title": "Col 6", "searchable": false, "orderable": false},
                {"targets": 7, "title": "Col 7", "searchable": false, "orderable": false}, 
                {"targets": 8, "title": "Col 8", "searchable": false, "orderable": false}, 
                {"targets": 9, "title": "Col 9", "searchable": false, "orderable": false}, 
                {"targets": 10, "title": "Action", "searchable": false, "orderable": false},                                                                                                
            ],
            "order": [
                [0, 'asc']
            ],
            "columns": [{
                    'data': 'contact_code', className: 'text-left dt-nowrap',
                }, {
                    'data': 'contact_name',
