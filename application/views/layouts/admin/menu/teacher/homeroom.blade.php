<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <table id="table_homeroom" class="table table-bordered dt-responsive nowrap align-middle" style="width:100%">
                    <thead>
                    </thead>
                    <tbody>
                    </tbody>
...
<!-- Grids in modals -->
<div class="modal fade" id="modal_homeroom" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_homeroom" action="javascript:void(0);" enctype="multipart/form-data">
                    <div class="row g-3"> 
                        ...
                        <div class="col-md-4 col-xs-12 padding-remove-side">
                            ...
                            <select name="detail_grade" id="detail_grade" class="form-select mb-3" disabled readonly>
                                <option value="0">Pilih</option>
                            </select>                                  
                        </div>
                        <div class="col-md-4 col-xs-12 padding-remove-side">
                            <label class="form-label">Department (IPA,IPS,E)</label>
                            <select name="detail_grade_department" id="detail_grade_department" class="form-select mb-3" disabled readonly>
                                <option value="0">Pilih</option>
                            </select>                                  
                        </div>
                        <div class="col-md-4 col-xs-12">
                            <label class="form-label">Sub (A,B,C)</label>
                            <select name="detail_grade_sub" id="detail_grade_sub" class="form-select mb-3">
                                <option value="0">Pilih</option>
                            </select>                                  
                        </div>     
                        <div class="col-md-12 col-xs-12 padding-remove-side">
                            <label class="form-label">Teacher (Teacher)</label>
