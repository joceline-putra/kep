<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <table id="table_teacher" class="table table-bordered dt-responsive nowrap align-middle" style="width:100%">
                    <thead>
                    </thead>
                    <tbody>
                    </tbody>
...
<!-- Grids in modals -->
<div class="modal fade" id="modal_teacher" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_teacher" action="javascript:void(0);" enctype="multipart/form-data">
                    <div class="row g-3">      
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control" id="user_birth" name="user_birth" readonly>
                            </div>
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
