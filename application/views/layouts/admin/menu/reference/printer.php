                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="text" name="text" type="text" class="form-control" rows="10"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-9 col-xs-12 col-sm-12 padding-remove-right">
                                                <div class="pull-right">
                                                    ...
                                                    <button id="btn_test_bluetooth_printer2" data-id="23" data-session="SESSONDATA" class="btn btn-default btn-small" type="button" style="display: inline;">
                                                        <i class="fas fa-print"></i>
                                                        Print 23
                                                    </button>                                                                                                                                                                                                                                                                  
