                                    ...
                                    <form id="form-master" name="form-master" method="" action="">    
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                              <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-left">
                                                <div class="form-group">
                                                  <label>Fee Pelaksana</label>
                                                  <input id="fee_1" name="fee_1" type="text" value="" class="form-control" readonly='true'/>
                                                </div>                          
                                              </div>
                                              <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side">            
                                                <div class="form-group">
                                                  <label>Fee Asisten</label>
                                                  <input id="fee_2" name="fee_2" type="text" value="" class="form-control" readonly='true'/>
                                                </div>                             
                                              </div>  
                                            </div>  
                                            -->                                                     
