...
<script>
    $(document).ready(function () {
        ...
        // new AutoNumeric('#fee_1', autoNumericOption);
        // new AutoNumeric('#fee_2', autoNumericOption);
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                ...
                {"targets": 2, "title": "Praktik", "searchable": true, "orderable": true},
                {"targets": 3, "title": "Harga", "searchable": true, "orderable": true},
        ...
        $(document).on("click", "#btn-save", function (e) {
            ...
            if (next == true) {
                var data = {
                    ...
                    fee_1: $("input[id='fee_1']").val(),
                    fee_2: $("input[id='fee_2']").val(),
            ...
            $.ajax({
                ...
                success: function (d) {
                    if (parseInt(d.status) == 1) { /* Success Message */
                        ...
                        $("#form-master input[name='fee_1']").val(d.result.product_fee_1);
                        $("#form-master input[name='fee_2']").val(d.result.product_fee_2);
    ...
    function formMasterSetDisplay(value) { // 1 = Untuk Enable/ ditampilkan, 0 = Disabled/ disembunyikan
        ...
        $("input[name='fee_1']").val(0);
        $("input[name='fee_2']").val(0);
