    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_user" action="javascript:void(0);" enctype="multipart/form-data">
                    <div class="row g-3">      
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="user_level" name="user_level" class="form-select mb-3" aria-label="Default select">
